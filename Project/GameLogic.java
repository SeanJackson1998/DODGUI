...
public class GameLogic {
    ...
    /*
     * returns a brand new version of the current map to the server
     * This is so the players can be added to the map to print out where they are,
     * but not to the actual map so they are actually in the map array
     * (they are just in a version of the map, not the real thing)
     */
    ...
    /*
     * returns the array list of players to god view thread
      * so that it can place them on the versio of the map passed above
     */
