...
public class ThreadClient extends Thread {
    ...
    /*
     * This method closes the socket connection between them and the server as well as removing them from the game
     */
        ...
        try (
            ...
            if (correctUser.getType() == 'B') {
                ...
                while (game.isGameRunning()) {
                    ...
                    // nothing is done with the bot's response as it doesn't matter to the user
